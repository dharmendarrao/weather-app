...
function isPayloadObject(
  obj: unknown
): obj is { payload: Record<string, unknown> } {
  return (
    typeof obj === "object" &&
    obj !== null &&
    "payload" in obj &&
...
function getPayloadConfigFromPayload(
  ...
  // Try extracting key from top-level payload if it's a string
  if (
    key in payload &&
    ...
    // Else try extracting it from nested payload
  } else if (key in payloadPayload) {
